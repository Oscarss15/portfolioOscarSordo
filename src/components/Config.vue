    ...
    <div class="config-panel" :class="{ open: isOpen }">
      ...
      <div class="config-item">
        ...
        <div class="theme-selector">
          ...
          >
            ...
            >
              <path
                d="M12 4.75a.75.75 0 010-1.5V4.75zm0 15.5a.75.75 0 010 1.5V20.25zm7.25-7.25a.75.75 0 011.5 0H19.25zm-15.5 0a.75.75 0 01-1.5 0H4.75zm12.02-5.28l.53-.53-.53.53zm-10.54 10.54l-.53.53.53-.53zm10.54 0l.53.53-.53-.53zm-10.54-10.54l-.53-.53.53.53zM12 7a5 5 0 100 10 5 5 0 000-10z"
              />
            </svg>
            Claro
          </div>
          ...
          >
            ...
            >
              <path
                d="M12 2a10 10 0 100 20 10 10 0 000-20zm0 2a8 8 0 110 16 8 8 0 010-16z"
              />
      ...
      <div class="config-item">
        ...
        <div class="notification-toggle" @click="toggleNotifications($event)">
          ...
          >
            <path
              d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zM7 11l5-5-1-1-4 4-2-2-1 1 3 3z"
            />
          </svg>
          <svg
            v-else
          ...
          >
            <path
              d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zM4.646 4.646l6.708 6.708-1.414 1.414L3.232 6.06 4.646 4.646z"
            />
          </svg>
        </div>
      </div>
...
onMounted(() => {
  ...
  } else if (savedColors && theme.value === "custom") {
    customColors.value = JSON.parse(savedColors);
    updateCustomTheme();
  }
});
...
const updateCustomTheme = () => {
  ...
  document.body.style.setProperty(
    "--color-primary",
    customColors.value.primary,
  );
  document.body.style.setProperty(
    "--color-secondary",
    customColors.value.secondary,
  );
  document.body.style.setProperty(
    "--color-tertiary",
    customColors.value.tertiary,
  );
...
.config-icon:hover {
  ...
  filter: drop-shadow(0 0 3px rgba(255, 255, 255, 0.2))
    drop-shadow(0 0 1.5px rgba(255, 255, 255, 0.1));
}
...
.config-panel {
  ...
  left: 15px;
  width: 240px;
  background: var(--color-primary, #303030);
  border-radius: 5px;
...
body[data-theme="light"] .config-panel {
...
.bounce {
  animation: option-bounce 0.4s ease forwards;
}
.bounce-small {
  animation: small-option-bounce 0.4s ease forwards;
}
...
.fade-slide-leave-active {
  transition:
    opacity 1s cubic-bezier(0.25, 0.8, 0.5, 1),
    transform 1s cubic-bezier(0.9, 0.8, 0.5, 1);
}
